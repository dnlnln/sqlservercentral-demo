IF OBJECT_ID('[dbo].[ArchiveOldUserPoints]') IS NOT NULL
	DROP PROCEDURE [dbo].[ArchiveOldUserPoints];
...
BEGIN
	...
	SET NOCOUNT OFF; -- Jim's change

	DECLARE @ArchiveMarkerDate DATETIME
	SET @ArchiveMarkerDate = '2001-01-01' -- Bob's other change
